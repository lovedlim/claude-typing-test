...
export const COMMANDS: CommandEntry[] = [
  ...
  { command: "claude -r", category: "claude", label: "세션 재개 (선택)" },
  { command: "claude --permission-mode plan", category: "claude", label: "플랜 모드" },
  { command: "claude --permission-mode acceptEdits", category: "claude", label: "편집 자동 승인" },
  ...
  { command: "claude --effort max", category: "claude", label: "최대 노력 모드" },
  ...
  { command: "claude update", category: "claude", label: "Claude Code 업데이트" },
  ...
  { command: "/exit", category: "slash", label: "세션 종료" },
  { command: "/plan", category: "slash", label: "플랜 모드 전환" },
  { command: "/commit", category: "slash", label: "커밋 메시지 생성" },
  { command: "/commit-push-pr", category: "slash", label: "커밋+푸시+PR 생성" },
  ...
  { command: "/status", category: "slash", label: "연결 상태 확인" },
  { command: "/release-notes", category: "slash", label: "업데이트 내역" },
